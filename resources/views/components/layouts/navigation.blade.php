<ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
        ...
        <div class="sidebar-brand-text mx-3">GSO</div>
    </a>
    ...
    @can('access buildings')
        ...
        <li class="nav-item {{ request()->is('buildings*') ? 'active' : '' }}">
            ...
            <div id="collapseBuildings" class="collapse {{ request()->is('buildings*') ? 'show' : '' }}"
    ...
    @can('access supply and equipments')
        ...
        <li class="nav-item {{ request()->is('supply-and-equipments*') ? 'active' : '' }}">
            ...
            <div id="collapseSupplyAndEquipments"
                class="collapse {{ request()->is('supply-and-equipments*') ? 'show' : '' }}"
                aria-labelledby="headingSupplyAndEquipments" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
    ...
    @can('access workflows')
        ...
        <li class="nav-item {{ request()->is('workflows*') ? 'active' : '' }}">
            ...
            <div id="collapseWorkflows" class="collapse {{ request()->is('workflows*') ? 'show' : '' }}"
                aria-labelledby="headingWorkflows" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
    ...
    @can('access forms')
        ...
        <li class="nav-item {{ request()->is('forms*') ? 'active' : '' }}">
            ...
            <div id="collapseForms" class="collapse {{ request()->is('forms*') ? 'show' : '' }}"
                aria-labelledby="headingForms" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
    ...
    @can('access faqs')
        ...
        <li class="nav-item {{ request()->is('faqs*') ? 'active' : '' }}">
            ...
            <div id="collapseFAQs" class="collapse {{ request()->is('faqs*') ? 'show' : '' }}"
