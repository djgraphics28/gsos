<div>
    @section('title', 'Create Supply & Equipment')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('Create Supply & Equipment') }}</h1>
    ...
    <div class="py-12 mb-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <!-- Card for Supply & Equipment Creation -->
            <div class="card shadow">
                <div class="card-body">
                    <form wire:submit.prevent="createSupply">
                        ...
                        <div class="form-group text-right">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Create Supply & Equipment
                            </button>
                        </div>
